...
//float angleX = accel_t_gyro.value.x_gyro/*zero error = -2.9*/;
//float angleY = accel_t_gyro.value.y_gyro/*zero error = 1.4*/;
//float angleZ = accel_t_gyro.value.z_gyro/*zero error = 1.4*/;
