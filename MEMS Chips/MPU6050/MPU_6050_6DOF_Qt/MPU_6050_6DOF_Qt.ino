...
//  Serial.println(accel_t_gyro.value.x_gyro/100, DEC);
//  Serial.print(F(", "));
...
float angleX = accel_t_gyro.value.x_gyro * 250.0/32767.0/*zero error = -2.9*/;
float angleY = accel_t_gyro.value.y_gyro * 250.0/32767.0/*zero error = 1.4*/;
float angleZ = accel_t_gyro.value.z_gyro * 250.0/32767.0/*zero error = 1.4*/;

//rotateX = rotateX + angleX;
//rotateY = rotateY + angleY;
////Serial.print(angleX);
////Serial.print(,");
...
//  Serial.print(F("accel x,y,z: "));
  Serial.print(accel_t_gyro.value.x_accel/100/2, DEC);
  Serial.print(", ");
  Serial.print(accel_t_gyro.value.y_accel/100/2, DEC);
  Serial.print(", ");
  Serial.print(accel_t_gyro.value.z_accel/100/2, DEC);
  Serial.print(",");
Serial.println("&");
